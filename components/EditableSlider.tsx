      ...
      <div className="flex items-center justify-between">
        ...
        {isEditing ? (
          <input
            ...
            step={step}
            autoFocus
            className="text-xs font-mono text-zinc-900 dark:text-white bg-zinc-100 dark:bg-black/20 px-2 py-0.5 rounded w-20 text-right border border-muzzie-copper focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
        ) : (
          <span
