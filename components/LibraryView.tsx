...
export const LibraryView: React.FC<LibraryViewProps> = ({ 
    ...
    return (
        ...
        <div className="flex-1 bg-white dark:bg-black overflow-y-auto custom-scrollbar p-6 lg:p-10 pb-32 transition-colors duration-300">
             ...
             {activeTab === 'liked' && (
                 <div>
                    <div className="bg-gradient-to-b from-muzzie-green/10 to-zinc-50 dark:from-muzzie-green/30 dark:to-zinc-900/50 p-6 rounded-xl flex items-end gap-6 mb-8 cursor-pointer hover:bg-zinc-100 dark:hover:bg-white/5 transition-colors group border border-zinc-200 dark:border-white/5" onClick={() => likedSongs.length > 0 && onPlaySong(likedSongs[0], likedSongs)}>
                         <div className="w-40 h-40 bg-gradient-to-br from-muzzie-copper to-muzzie-green rounded shadow-2xl flex items-center justify-center">
