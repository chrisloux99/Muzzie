                ...
                <div className="p-5 pb-24 lg:pb-32 space-y-6">
                    ...
                    <div className="space-y-3">
                                ...
                                {!isEditingTitle ? (
                                    ...
                                    <div className="w-full">
                                        <input
                                            ...
                                            className="w-full text-xl font-bold text-zinc-900 dark:text-white bg-white dark:bg-black/30 border border-zinc-200 dark:border-white/10 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-muzzie-copper/40"
                                            maxLength={120}
                                            autoFocus
                                        />
                                        <div className="flex items-center gap-2 mt-2">
                                            <button
                                                ...
                                                className="px-3 py-1.5 rounded-md text-xs font-semibold bg-muzzie-copper/90 text-white hover:bg-muzzie-terracotta disabled:opacity-60"
                                            >
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-muzzie-copper to-muzzie-green flex items-center justify-center text-xs font-bold text-white shadow-sm ring-2 ring-white dark:ring-black">
...
const ActionButton: React.FC<{ icon: React.ReactNode; label?: string; active?: boolean; onClick?: () => void }> = ({ icon, label, active, onClick }) => (
    <button
        onClick={onClick}
        className={`flex items-center gap-1.5 ${active ? 'text-muzzie-copper' : 'text-zinc-400'} hover:text-black dark:hover:text-white transition-colors`}
    >
        {icon}
