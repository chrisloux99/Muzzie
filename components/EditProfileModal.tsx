                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        maxLength={50}
                                        className="flex-1 bg-zinc-50 dark:bg-black border border-zinc-300 dark:border-zinc-800 rounded-lg px-3 py-2 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:border-muzzie-copper transition-colors"
                                    />
                                </div>
                                {usernameError && (
