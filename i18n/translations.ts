...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to Muzzie',
    ...
    emailBody: 'Hey!\n\nI created this AI-generated song and thought you\'d love it:\n\n"{title}" by {creator}\n{style}\n\nListen here: {url}\n\nMade with Muzzie - free and open source local AI music generation!',
  ...
  ja: {
    ...
    emailBody: 'こんにちは！\n\n私がこのAI生成の曲を作りました。気に入ってもらえると思います：\n\n「{title}」by {creator}\n{style}\n\nここで聴いてください：{url}\n\nMuzzieで作成 - 無料でオープンソースのローカルAI音楽生成！',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'Muzzie에 오신 것을 환영합니다',
